...
@WebServlet("/getneedsendgoodes")
public class getneedsendgoodes extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String, Object>> goodeslist= goodesDao.getneedsendgoodes(Integer.valueOf(uid));
