...
<body>
    <div class="main">
        <div class="register_warp">
            <form action="/webLogin_war_exploded/registerServlet" method="post">
                <div id="title" ><span >用户注册</span></div>
                ...
                <div><span>邮箱/手机</span><input type="text" placeholder="请输入邮箱/手机号" name="number" id="phonenum"> <span class="tips"></span></div>
